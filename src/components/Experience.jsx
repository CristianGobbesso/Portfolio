    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-[220px_1fr]">
          ...
          {/* Contenido */}
          <div className="border-l border-zinc-200 pl-8 dark:border-zinc-800">
            <div>
        ...
        {/* Diferencial */}
        <div className="mt-16 rounded-2xl border border-violet-200 bg-violet-50/50 p-8 sm:p-10 dark:border-violet-500/20 dark:bg-violet-500/5">
